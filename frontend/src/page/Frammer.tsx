...
export default function FarmersPage() {
  ...
  const filteredFarmers = farmersData.filter((farmer) => {
    ...
    const matchesCrop =
      !selectedCrop || farmer.crops.includes(selectedCrop);
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-12">
              ...
              <p className="text-xl text-foreground/70">
                Connect directly with farmers and purchase quality organic stubbles.
              </p>
            </div>
              ...
              {filteredFarmers.map((farmer) => (
                ...
                >
                  ...
                  <div className="space-y-2 mb-4 text-sm text-foreground/70">
                    <p>
                      <span className="font-semibold text-foreground">Farm Size:</span>{' '}
                      {farmer.farmSize}
                    </p>
                    <p>
                      <span className="font-semibold text-foreground">Crops:</span>{' '}
                      {farmer.crops.join(', ')}
                    </p>
                  </div>
                  ...
                  <div className="flex items-center justify-between mb-4 pb-4 border-b border-border">
                    ...
                    <div className="flex items-center gap-1 text-accent">
                      <TrendingUp size={16} />
                      <span className="text-sm font-semibold">{farmer.listings} listings</span>
                    </div>
                  </div>
                  ...
                  <Button
                    ...
                    asChild
                  >
                    <NavLink to={`/farmers/${farmer.id}`}>View Products</NavLink>
                  </Button>
                </Card>
              ))}
            </div>
            ...
            {filteredFarmers.length === 0 && (
              <div className="text-center py-12">
                <p className="text-xl text-foreground/60">
                  No farmers found matching your criteria. Try adjusting your filters.
                </p>
              </div>
            )}
          </div>
