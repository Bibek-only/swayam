...
import { CheckCircle, Users, Leaf, TrendingUp, Award, Sprout } from 'lucide-react';
...
const SolutionsSection = () => {
  ...
  return (
    <section id="solutions" className="py-20 px-4 sm:px-6 lg:px-8  from-accent/5 to-primary/5">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-2 mb-4">
            <CheckCircle className="text-primary" size={24} />
            <span className="text-primary font-semibold text-lg">Our Impact</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
            Comprehensive Solutions
          </h2>
          <p className="text-xl text-foreground/70 max-w-2xl mx-auto">
            We create value for all stakeholders: farmers, organizations, and the environment.
          </p>
        </div>
